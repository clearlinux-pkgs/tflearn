...
Version  : 0.3.1
Release  : 6
URL      : https://github.com/tflearn/tflearn/archive/0.3.1.tar.gz
Source0  : https://github.com/tflearn/tflearn/archive/0.3.1.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1495134889
